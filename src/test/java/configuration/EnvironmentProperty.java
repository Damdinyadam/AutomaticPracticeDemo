...
public class EnvironmentProperty {
    private final String APP_ENV; //nazwa environment
    private static Logger logger = LoggerFactory.getLogger(EnvironmentProperty.class);
    private final BrowserEnvironment BROWSER_ENV; //nazwa browsera
    ...
    private static void setSystemPropertiesFromPathUrl(String dirName) {//nazwa folderu =dirName
        ...
        if (url != null) {
            ...
            logger.warn("No such property directory '{}' present in the resources, make sure you are providing correct directory");
        }
    }
    ...
    private static class EnvironmentPropertySingleton {
        private static final EnvironmentProperty INSTANCE = new EnvironmentProperty(); //jeden egz obiektu
    }
}
